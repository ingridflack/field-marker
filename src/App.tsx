  ...
  return (
    <div>
      ...
      <div style={{ position: "relative" }}>
        <MapContainer center={fieldGeoJson.features[0].geometry.coordinates[0].map(([lat, lon]) => [lon, lat])[0]} zoom={13} scrollWheelZoom={false} style={{ height: "600px" }} zoomControl={false}>
          <TileLayer
        ...
        <PointsList points={points} selectedPoint={selectedPoint} />
      </div >
    </div >
  )
}
