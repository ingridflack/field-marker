    ...
    return (
        <S.ModalOverlay onClick={onCloseModal}>
            <S.Modal onClick={(e) => e.stopPropagation()}>
                <S.TopBar>
                    <S.CloseButton onClick={onCloseModal} type="button">&#x2715;</S.CloseButton>
                </S.TopBar>
                <S.Header>
                    <p>{deleteModal.type === 'delete' ? 'Excluir ponto selecionado?' : 'Excluir todos os pontos?'}</p>
                </S.Header>
